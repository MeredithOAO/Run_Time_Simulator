...
//             {
//                  printf("\nG-DM Simulation Result: All Task Meet Deadline \n\n");
//             }else {

//                 printf("\nG-DM Simulation Miss Deadline. Need to try G-DP Scheduling. \n\n");
//                 Reset_Gloabl_Task();
//                 try_all_ppp(Calculate_LCM(Global_Tasks,NUMBER_TASK));
...
// printf("RTA_DP not Pass Times = %d",meet_condition_3_times);
}
